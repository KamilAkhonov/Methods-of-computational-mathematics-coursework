...
namespace Clinic {
    ...
    public partial class Database1DataSet1 : global::System.Data.DataSet {
        ...
        public partial class DoctorsDataTable : global::System.Data.TypedTableBase<DoctorsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public DoctorsRow AddDoctorsRow(int ID, string Name) {
...
namespace Clinic.Database1DataSet1TableAdapters {
    ...
    public partial class DoctorsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Doctors] ([ID], [Name]) VALUES (@ID, @Name);\r\nSELECT ID, Name " +
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Doctors] SET [ID] = @ID, [Name] = @Name WHERE (([ID] = @Original_ID" +
                ") AND ([Name] = @Original_Name));\r\nSELECT ID, Name FROM Doctors WHERE (ID = @ID)" +
                "";
